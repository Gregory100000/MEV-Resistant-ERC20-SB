 ...
 *
 * *GregoryUnderscore - 4/25/22 - Add ownable to allow handling of time restriction whitelist.
 */
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function _beforeTokenTransfer(
		...
		// If the from address is not in the restriction whitelist, verify it is not trasnferring/selling in the same block. 
	...
	*/
    function addTimeRestrictionWhitelist(address whitelistAddy) public onlyOwner {
		_transferTimeWhitelist[whitelistAddy] = true;
	}
